    ...
    class Program
    {
        static void Main()
        {
            ...
            if (true)
            {
                ...
                Task t1 = new Task(CreateCampaignAndBatches);
                t1.Start();
            }
        ...
        static async void CreateCampaignAndBatches()
        {
            var token = await GetGoogleOAuthTokenAsync();
            ...
            if (__PROD__)
            {
                rootlUrl = "https://admin-dot-mq-vouchers.appspot.com/api/"; //PROD
                campaignName = "Crowdmix Influencers Reward";
                productId = "166";
                productName = "30 days voucher duration";
                redemptionUrl = "http://traxm.tv/a";
                //if want to just export an existing batch of vouchers then specify batch name here
                exportBatchName = "prod_batch2016-05-20T033610_100";
                removeRemainingFreeTrial = "false";
                noVouchersPerBatch = 100;
                batchStartDate = new DateTime(2016, 5, 20);
                batchEndDate = new DateTime(2016, 6, 30);
                //batchEndDate = batchStartDate.AddDays(1);
                batchPrefix = "prod_";
            }
            else
            {
                rootlUrl = "https://admin-dot-mq-vouchers-qa.appspot.com/api/"; //QA
                campaignName = "Neil Test Campaign 3";
                productId = "166";
                productName = "30 days voucher duration";
                redemptionUrl = "http://traxm.tv/a";
                ...
                noVouchersPerBatch = 50;
                batchStartDate = new DateTime(2016, 2, 23);
                batchEndDate = batchStartDate.AddDays(180);
                batchPrefix = "qa_";
            }
        ...
        static async void HttpVoucherReaderTesterAsync()
        {
            ...
            string rootlUrl = "https://2-dot-admin-dot-mq-vouchers.appspot.com/api/"; //PROD
            string url = string.Empty;
